...
MyApplet.prototype = {
  ...
  _init: function(orientation, panelHeight, instanceId) {
      ...
      try {
        this.settings = new Settings.AppletSettings(this, "trafic@dim.ru", this.instanceId);
        ...
        this.trash_path = 'file:///tmp/traficdim_sv';
    ...
    _onTrashChange() {
      ...
      this.idle=GLibFile.new_file("/tmp/traficdim_sv", "r");
